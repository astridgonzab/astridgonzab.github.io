...
## **6. Conclusión**
El análisis del modelo de regresión muestra que al menos una de las variables predictoras tiene un impacto significativo sobre el Tiempo_Entrega_min. Dado que el p-valor es menor que el nivel de significancia (α=0.05), rechazamos la hipótesis nula y concluimos que el modelo es estadísticamente significativo para predecir el tiempo de entrega.
...
```
Como se puede observar, Num_Paquetes es la única variable que tiene un impacto significativo sobre el Tiempo_Entrega_min según los resultados de la prueba de hipótesis. En cambio, Distancia_km y Velocidad_Trafico no muestran una relación significativa con el tiempo de entrega, esto sugiere que, en el contexto de este modelo de regresión, el número de paquetes es el factor más relevante para predecir el Tiempo_Entrega_min.
...
# **8.  Coeficiente de correlación de Pearson (cálculo e interpretación)**
